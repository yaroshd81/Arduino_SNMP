...
class IntegerCallback: public ValueCallback {
  public:
    IntegerCallback(SortableOIDType* oid, int* value, const int minValue, const int maxValue): ValueCallback(oid, INTEGER), value(value), minValue(minValue), maxValue(maxValue) {};
...
public:
    IpAddressCallback(SortableOIDType* oid, IPAddress *value): ValueCallback(oid, NETWORK_ADDRESS), value(value) {};
